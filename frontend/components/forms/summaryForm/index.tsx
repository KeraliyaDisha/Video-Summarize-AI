...
import { generateSummaryService } from "@/data/services/summaryService";
import { createSummaryAction } from "@/data/actions/summaryAction";
...
export function SummaryForm() {
  ...
  async function handleFormSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      console.error("Error in createSummaryAction:", error);
